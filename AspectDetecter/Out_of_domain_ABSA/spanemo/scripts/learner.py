...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        torch.save(model.state_dict(),
                   '/Users/jordanharris/SCAPT-ABSA/AspectDetecter/Out_of_domain_ABSA/SpanEmo/models/SemEval_' + self.cur_date + '_checkpoint.pt')
...
class Trainer(object):
    ...
    def optimizer(self, args):
        ...
        num_train_steps = (int(len(self.train_data_loader.dataset)) /
                           int(args['train_batch_size'])) * int(args['max_epoch'])
...
class EvaluateOnTest(object):
    ...
    def predict(self, device='cpu:0', pbar=None):
        ...
        with torch.no_grad():
            index_dict = 0
            with open('/Users/jordanharris/SCAPT-ABSA/AspectDetecter/Out_of_domain_ABSA/SpanEmo/predict_' + glob.glob('*') + '.csv', 'w') as f:
                writer = csv.writer(f)
