...
class BertEncoder(nn.Module):
    def __init__(self, lang='English', bert_type='BERT'):
        """
...
class SpanEmo(nn.Module):
    def __init__(self, output_dropout=0.1, lang='English', joint_loss='joint', alpha=0.2, bert_type='BERT'):
        ...
        self.bert = BertEncoder(lang=lang, bert_type=bert_type)
